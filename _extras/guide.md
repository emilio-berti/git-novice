...
## [Automated Version Control]({{ page.root }}{% link _episodes/03-basics.md %})
...
## [Setting Up Git]({{ page.root }}{% link _episodes/04-setup.md %})
...
## [Creating a Repository]({{ page.root }}{% link _episodes/05-create.md %})
...
## [Tracking Changes]({{ page.root }}{% link _episodes/06-changes.md %})
...
## [Collaborating]({{ page.root }}{% link _episodes/12-collab.md %})
...
## [Conflicts]({{ page.root }}{% link _episodes/13-conflict.md %})
...
## [Open Science]({{ page.root }}{% link _episodes/14-open.md %})

## [Citation]({{ page.root }}{% link _episodes/15-citation.md %})

## [Hosting]({{ page.root }}{% link _episodes/16-hosting.md %})
